...
Prerequisite:
1. GitLab is running. If not, start it using sudo gitlab-ctl start.
2. Gitlab data must be hidden for the backup process.
...
```
Restore gitlab.rb & gitlab-secrets files
